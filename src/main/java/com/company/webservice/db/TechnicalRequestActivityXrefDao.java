...
public interface TechnicalRequestActivityXrefDao {
    @SqlQuery("select * from create_technical_request_activity_xref(:technicalRequestId, :activityId, :employeeId)")
    ...
    @SqlQuery("select * from read_technical_request_activity_xref(:id, :technicalRequestId, :activityId, :employeeId)")
    @RegisterBeanMapper(TechnicalRequestActivityXref.class)
    ...
    @SqlQuery("select * from update_technical_request_activity_xref(:id, :technicalRequestId, :activityId, :employeeId)")
    @RegisterBeanMapper(TechnicalRequestActivityXref.class)
    TechnicalRequestActivityXref update(@BindBean TechnicalRequestActivityXref technicalRequestActivityXref);

    @SqlQuery("select * from delete_technical_request_activity_xref(:id, :technicalRequestId, :activityId, :employeeId)")
    @RegisterBeanMapper(TechnicalRequestActivityXref.class)
