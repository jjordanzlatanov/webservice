...
public interface TechnicalRequestBlockXrefDao {
    @SqlQuery("select * from create_technical_request_block_xref(:technicalRequestId, :blockId)")
    ...
    @SqlQuery("select * from read_technical_request_block_xref(:id, :technicalRequestId, :blockId)")
    @RegisterBeanMapper(TechnicalRequestBlockXref.class)
    ...
    @SqlQuery("select * from update_technical_request_block_xref(:id, :technicalRequestId, :blockId)")
    @RegisterBeanMapper(TechnicalRequestBlockXref.class)
    TechnicalRequestBlockXref update(@BindBean TechnicalRequestBlockXref technicalRequestBlockXref);

    @SqlQuery("select * from delete_technical_request_block_xref(:id, :technicalRequestId, :blockId)")
    @RegisterBeanMapper(TechnicalRequestBlockXref.class)
